...
var defaultMenuOptions = []keys.KeyName{keys.KeyNew, keys.KeyPrompt, keys.KeyClaudeResume, keys.KeyHelp, keys.KeyQuit}
...
func (m *Menu) addInstanceOptions() {
	...
	options := []keys.KeyName{keys.KeyNew, keys.KeyPrompt, keys.KeyClaudeResume, keys.KeyKill}
...
func (m *Menu) String() string {
	...
	groups := []struct {
		...
		{0, 3}, // Instance management group (n, N, C, d)
